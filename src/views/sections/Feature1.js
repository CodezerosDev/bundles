...
function Feature1() {
  return (
    <>
      <div className="section features-1" id="Staking">
        <Container>
          <ScrollAnimation animateIn="fadeInLeft" animateOnce>
            <Row>
              <Col className="mx-auto text-center" md="8">
                <Badge className="mb-3" color="primary" pill></Badge>
                <p className="display-3">Bund Staking-NFT</p>
                <span className="lead display-5">
                  Bundles allows user to stake their $BUND to earn either more
                  $BUND or $BUNDNFT tokens, that can be used on the marketplace.{" "}
                </span>
              </Col>
            </Row>
          </ScrollAnimation>
                ...
                <Card className="card-project">
                  ...
                  <CardBody>
                    ...
                    <p className="card-description text-black display-5">
                      Earn BUNDNFT by depositing BUND to the Liquidity pool{" "}
                    </p>
                  </CardBody>
                </Card>
              </Col>
              <Col lg="5" md="6">
                ...
                <Card className="card-project">
                  ...
                  <CardBody>
                    ...
                    <p className="card-description text-black display-5">
                      Earn BUNDNFT by depositing BUND-ETH LP <br></br>to the
                      Liquidity pool{" "}
                    </p>
                  </CardBody>
                </Card>
