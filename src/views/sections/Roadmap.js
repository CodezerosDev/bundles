...
export const Roadmap = () => {
  return (
    <section className="section section-lg" id="Roadmap">
      <Container className="content-center">
        <ScrollAnimation animateIn="fadeInUp" animateOnce>
          <p className="display-3 text-center text-tertiary">Project Roadmap</p>
          <p className="text-center text-tertiary display-5">
            Since the Bundles journey started in October 2020, we have achieved
            a great deal. Have a look at what we have planned for 2021!
          </p>
