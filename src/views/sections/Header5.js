          ...
          <ScrollAnimation animateIn="fadeInLeft" animateOnce>
            ...
            <Row className="align-items-center text-left">
              <Col lg="6" xs="12">
                ...
                Join our Prediction Pools and compete against users to <br></br>
                earn as much as<span  className="display-5 text-primary"> 39.6%  </span>over 48 hours in returns. </h1>
